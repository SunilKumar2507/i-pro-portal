        ...
        <div className="contact-page">
            ...
            <main>
                ...
                <section className="contact-main-grid">
                    ...
                    <aside className="contact-details-card"><span className="contact-kicker">Contact details</span><h2>Prefer to reach us directly?</h2><div className="contact-details-list"><a href="tel:08023414133" className="contact-detail"><b><FaPhoneAlt /></b><span><strong>Call us</strong><small>080 23414133</small></span></a><a href="mailto:customerfirst@iproinfinity.com" className="contact-detail"><b><FaEnvelope /></b><span><strong>Email</strong><small>customerfirst@iproinfinity.com</small></span></a><div className="contact-detail"><b><FaMapMarkerAlt /></b><span><strong>Visit us</strong><small>#16/1, 3rd Cross, RMV 2nd Stage, 4th Block,<br />MLA Layout, Sanjaynagar,<br />Bengaluru 560094</small></span></div></div></aside>
                </section>
